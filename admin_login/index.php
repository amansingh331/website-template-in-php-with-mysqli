...
$query="SELECT * FROM social_link,admin_users";
  ...
  <div class="row">
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="sidebar-sticky pt-3">
        ...
        <li class="nav-item">
            <a class="nav-link" href="../admin_login/index.php">
              <span data-feather="home"></span>
            Home
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="?editipinfo=true">
              <span data-feather="home"></span>
            ip info
            </a>
          </li>
         <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="?editgallery=true">
              <span data-feather="archive"></span>
              Edit gallery
            </a>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link" href="?editblog=true">
              <span data-feather="archive"></span>
              Edit blog
            </a>
          </li>
